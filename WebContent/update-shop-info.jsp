						...
						<div class="panel-body">
							<form role="form" action="update-shop-info-process.jsp" method="post">
								...
								<div class="form-group">
									<label>Shop Id</label> <input class="form-control" type="text"
										name="sid" value="<%=resultset.getString(1)%>" readonly/>

								</div>
								<div class="form-group">
									<label>Shop Name</label> <input class="form-control"
										type="text" name="sname" value="<%=resultset.getString(2)%>" />
