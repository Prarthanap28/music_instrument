...
<body>
	<div class="navbar navbar-inverse set-radius-zero" style="background-color: blue;>
		<div class="container">
				...
				<div class="col-md-12">
					<div class="navbar-collapse collapse ">
						<ul id="menu-top" class="nav navbar-nav navbar-right">
							<li><a href="index.jsp" style="text-shadow: 2px 2px 4px #000000;">Admin Login</a></li>
	...
	<div class="content-wrapper">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6">
					<img src="assets/img/musical-instruments.jpg" style="width: 450px;"></img>
				</div>
				<div class="col-md-6">
					<div class="panel panel-info">
						...
						<div class="panel-body">
							<%
								String credential = (String) session.getAttribute("fail");
								if (credential != null) {
