										...
										<tbody>
											<tr>
												<td><input class="form-control" type="text"
													value="<%=custId%>" name="custId" /></td>
												<td><input class="form-control" type="text"
													value="<%=prod_id%>" name="prod_id" /></td>
												<td><input class="form-control" type="text"
													name="pname" value="<%=pname%>" /></td>
												<td><input class="form-control" type="text"
													name="prate" value="<%=prod_rate%>" id="prate" /></td>
												<td><input class="form-control" type="text"
													name="pquantity" id="pquantity" onkeyup="myFunction()" /></td>
												<td><input class="form-control" type="text"
													name="totalAmount" id="totalAmount" value="" /></td>
												<td><input type="submit" value="Add Sales"
